...
INSERT INTO
    VAGAS (id, codigo, status) VALUES (10, 'T-01', 'OCUPADA');

INSERT INTO
    VAGAS (id, codigo, status) VALUES (20, 'T-02', 'OCUPADA');

INSERT INTO
    VAGAS (id, codigo, status) VALUES (30, 'T-03', 'OCUPADA');
...
INSERT INTO
    CLIENTES_TEM_VAGAS (numero_recibo, placa, marca, modelo, cor, data_entrada, id_cliente, id_vaga)
VALUES (
        '20240501-095500', 'PLP-1544', 'FIAT', 'ARGO', 'BRANCO', '2024-05-01 09:55:00', 200, 50
    );

INSERT INTO
    CLIENTES_TEM_VAGAS (numero_recibo, placa, marca, modelo, cor, data_entrada, id_cliente, id_vaga)
VALUES (
        '20240501-095600', 'FRD-9847', 'FORD','ECOSPORT', 'Preto', '2024-05-01 09:56:00', 100, 30
    );

INSERT INTO
    CLIENTES_TEM_VAGAS (numero_recibo, placa, marca, modelo, cor, data_entrada, id_cliente, id_vaga)
VALUES (
        '20240501-095700', 'PLP-6666', 'FIAT', 'ARGO', 'BRANCO', '2024-05-01 09:57:00', 200, 20
    );

INSERT INTO
    CLIENTES_TEM_VAGAS (numero_recibo, placa, marca, modelo, cor, data_entrada, id_cliente, id_vaga)
VALUES (
        '20240501-095800', 'PLP-4444', 'FIAT', 'ARGO', 'BRANCO', '2024-05-01 09:58:00', 200, 10
    );