...
public class JwtAuthorizationFilter extends OncePerRequestFilter {
     ...
     * If the token is invalid or expired, it logs a warning and continues the filter chain.
     * Otherwise, it extracts the username from the token and sets it in the request's authentication.
    ...
    /**
     * Authenticates the user based on the provided username and sets the authentication token in the security context.
     *
